...
fun ShowCategories(categories: List<Category>) {
    Column(){
        Text(text = "Spent by Categories", modifier = Modifier.padding(vertical = 4.dp).align(alignment = Alignment.CenterHorizontally))
    ...
    ElevatedButton(onClick = { println("Click") },
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1.2f)) {
                ...
                modifier = Modifier.height(25.dp).padding(top = 6.dp))

                Text(
                    text = "$" + category.spentAmount.toString(),
                    modifier = Modifier.align(alignment = Alignment.CenterHorizontally).padding(top = 6.dp),
                    fontSize = 12.sp)
            }
